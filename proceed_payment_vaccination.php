...
$mail = $_SESSION['vaccination_email'];
$payment_type = 1;
$booking_id = $_GET['unique_id'];
...
if($payment_type==1){
    ...
    $amount = $row['vaccine_cost'];
    $purpose = 'Payment for Vaccination';
}
?>
...
<body>
    <?php include 'includes/vaccination_payment_navbar.php';?>
