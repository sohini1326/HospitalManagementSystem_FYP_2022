...
<head>
	<meta charset="utf-8">
	<title>Apply for senior citizen scheme | CareVista</title>
...
<body>
	...
	<div id="donor_form_box">
		...
		<form id="donor_form" method="POST" action="add_applicants_hcs.php">
			...
			if($fetched_result['DOB']!=$date_default){
  				...
  				echo '<input type="number" id="age" name="age" class="inpt-frmt" value="'.$age.'" readonly>';

			}else{
				echo '<input type="number" id="age" name="age" min="60" class="inpt-frmt" placeholder="<Your current age>" required>';
			}
			...
			if($fetched_result['town']!=NULL){
				...
				echo '<input class="inpt-frmt" type="text" name="city" id="city" placeholder="<Kolkata>" required><br>';
			}
		    ...
		    <input type="submit" name="" class="btn btn-dark" id="donor_details_sbmt_btn" 
		    	value="Apply">	
		</form>
	</div>
	...
	<script type="text/javascript" src="js/senior_citizen_hcs_apply_form.js"></script>
