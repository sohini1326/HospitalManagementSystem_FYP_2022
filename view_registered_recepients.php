...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/view_registered_recepient.css">
    ...
    <div style="margin:15px;">
            <table id="myTable1" class="table table-dark table-bordered table-hover">
                <thead class="thead-light">
                    <tr>
                        <th colspan="7" class="bg-info text-white">RECEPIENT DETAILS</th>
                    </tr>
                    <tr>
                        <th scope="col">S.NO</th>
                        <th scope="col">RECEPIENT PHOTO</th>
                ...
                <tbody>
                    <?php
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            $imageURL = 'Recepient_Documents/passport_photo/'.$row["photo"];
                            $cardURL = 'Recepient_Documents/adhaar_card/'.$row["adhaar_card"];
                            echo '<tr>
                                    <td>'.$s_no.'</td>
                                    <td scope="row"><img src="'.$imageURL.'" class="recepient-dp"></td>
