...
<head>
	<meta charset="utf-8">
	<title>Blood Donor Form | CareVista</title>
...
<body>
		...
		<div id="donor_form">
			...
			<select name="b_groups" id="b_groups" class="inpt-frmt">
				...
				<?php
					...
					$query = "SELECT * FROM blood_groups WHERE emergency_status IS NULL";
	...
	<script type="text/javascript" src="js/blood_donor_form.js"></script>
