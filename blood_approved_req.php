...
<head>
	<meta charset="utf-8">
	<title>Blood Approved Request</title>
...
<body>
	...
	<div class="table-box">
		<table style="width:100%">
			...
			$query="SELECT * FROM blood_donor_details WHERE req_status LIKE 'Approved'";
		...
		<table style="width:100%">
			...
			$query="SELECT * FROM emergency_blood_donor_details WHERE req_status LIKE 'Approved'";
			$result=mysqli_query($conn,$query);
			while($row=mysqli_fetch_assoc($result)){
				echo '<tr>
				<td>'.$row['donor_name'].'</td>
