...
<body>
	...
	while($row=mysqli_fetch_assoc($result)){
		echo '<div class="box">
					<div class="test" style="height:38vh; ">
					...
					echo	'<i class="fas fa-eye view"></i>
						...
						<div class="test_right card text-white bg-info hidden">
							...
							<h1>Report: <a href="download_di_report.php?b_id='.$row['booking_id'].'"> View your report </a></h1>
							<h3 style="margin-left:38%; "><a href="diagonistic_imaging_documents/'.$row['docs'].'">Download your documents</a></h3>
