...
<?php
  ...
  ?>
<h1 style="text-align:center;text-decoration:underline;MARGIN-TOP:10PX;">CANCELLED APPOINTMENTS</h1>
                ...
                <tbody>
                    <?php
                        ...
                        $query = "SELECT * FROM vaccination_bookings b
                                  INNER JOIN vaccine_list l on l.vaccine_id=b.vaccine_id WHERE vaccination_status='CANCELLED'";
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            echo '<tr class="table-danger">
                                    ...
                                    <td>
                                        <a href="admin_vaccination_functionalities.php?unique_id='.$row['unique_id'].'&pending=true" data-toggle="tooltip" data-placement="bottom" title="RESTORE"><i class="fas fa-undo-alt"></i></a>
